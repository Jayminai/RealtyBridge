         ...
         <div class="flex">
            ...
            <div class="box">
               ...
               <select name="min" class="input" required>
                  ...
                  <option value="15000">150k</option>
                  <option value="20000">200k</option>
                  <option value="30000">300k</option>
                  <option value="40000">400k</option>
                  <option value="50000">500k</option>
                  <option value="100000">1 Million</option>
                  <option value="500000">5 Million</option>
                  <option value="1000000">10 Million</option>
                  <option value="2000000">20 Million</option>
                  <option value="3000000">30 Million</option>
                  <option value="4000000">40 Million</option>
                  <option value="4000000">40 Million</option>
                  <option value="5000000">50 Million</option>
                  <option value="6000000">60 Million</option>
                  <option value="7000000">70 Million</option>
                  <option value="8000000">80 Million</option>
                  <option value="9000000">90 Million</option>
                  <option value="10000000">100 Million</option>
                  <option value="20000000">200 Million</option>
                  <option value="30000000">300 Million</option>
                  <option value="40000000">400 Million</option>
                  <option value="50000000">500 Million</option>
                  <option value="60000000">600 Million</option>
                  <option value="70000000">700 Million</option>
                  <option value="80000000">800 Million</option>
                  <option value="90000000">900 Million</option>
                  <option value="100000000">1 Billion</option>
                  <option value="150000000">5 Billion</option>
                  <option value="200000000">10 Billion</option>
               </select>
            </div>
            <div class="box">
               <p>maximum budget</p>
